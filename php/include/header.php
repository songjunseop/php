        ...
        ?>
                ...
                <a href="../mypage/mypage.php" class="setting"> 
                    ...
                    <!-- <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <mask id="mask0_2_955" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="30" height="30">
                        ...
                        <g mask="url(#mask0_2_955)">
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M15 30.076H26.154V26.523C26.154 25.35 25.352 23.866 24.372 23.226L18.937 19.926C18.512 19.673 18.024 19.306 18.024 18.233C18.024 17.53 18.617 16.973 18.796 16.753C19.6683 15.8065 20.1517 14.5661 20.15 13.279V10.646C20.15 7.79199 17.846 6.15399 15 6.15399C12.153 6.15399 9.84801 7.79199 9.84801 10.646V13.279C9.84801 14.623 10.365 15.838 11.204 16.753C11.382 16.973 11.975 17.53 11.975 18.233C11.975 19.307 11.487 19.673 11.062 19.925L5.62601 23.226C4.64701 23.866 3.84601 25.35 3.84601 26.523V30.076H15Z" fill="#595959"/>
                        </g>
                    </svg> -->
