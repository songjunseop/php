                    ...
                    <div class="board__search">
                        <form action="boardSearch.php" name="boardSearch" method="GET">
                            <fieldset>
                                ...
                                <div>
                                    <select name="searchOption" class="search-option" id="search-option">
...
<?php
    ...
    // LIMIT 0,  10 --> page1   0,  {$pageView * 1}
    // LIMIT 10, 20 --> page2   10, {$pageView * 2}
    // LIMIT 20, 30 --> page3   20, {$pageView * 3}
    // LIMIT 30, 40 --> page4   30, {$pageView * 4}
