    ...
    if($result){
        ...
        if($memberID == 1){
            ...
            if($fileExtension == "jpg" || $fileExtension == "jpeg" || $fileExtension == "png" || $fileExtension == "gif"){
                $sql = "INSERT INTO myNews(memberID, newsTitle, newsContents, newsAuthor, newsView, newsImgFile, newsDelete, newsRegTime) 
                VALUES('$memberID', '$newsTitle', '$newsContents', '$newsAuthor', '$newsView', '$newsImgName', '1', '$newsRegTime')";
                $result = $connect -> query($sql);
                ...
                $sql = "INSERT INTO myNews(memberID, newsTitle, newsContents, newsAuthor, newsView, newsImgFile, newsDelete, newsRegTime) 
                VALUES('$memberID', '$newsTitle', '$newsContents', '$newsAuthor', '$newsView', 'default.jpg', '1', '$newsRegTime')";
                $result = $connect -> query($sql);
                $result = move_uploaded_file($newsImgTmp, $myNewsDir.$newsImgName);
            }
        } else {
